        ...
        <>
          <div className=" fixed z-10  h-screen w-screen bg-opacity-20 top-0 left-0 flex justify-center items-center ">
            <div
              ...
              className="    md:max-w-[80%] max-w-[95%]  md:h-auto max-h-auto grid place-items-center  grid-flow-row grid-rows-12 bg-white rounded-xl p-3 border-2 border-gray-500 gap-1 "
            >
